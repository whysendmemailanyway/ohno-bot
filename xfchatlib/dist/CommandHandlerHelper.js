...
const requireClean_1 = require("./requireClean");
class CommandHandlerHelper {
    constructor(commandHandler) {
        this.commandHandler = commandHandler;
    }
    internalLoadPlugin(pluginName, commandHandler) {
    ...
    internalUnloadPlugin(pluginName) {
        ...
        if (pluginIndex !== -1) {
            ...
            if (plugin.instantiatedPlugin.shutdown)
                plugin.instantiatedPlugin.shutdown();
...
exports.CommandHandlerHelper = CommandHandlerHelper;
//# sourceMappingURL=CommandHandlerHelper.js.map